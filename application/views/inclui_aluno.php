<div class="row">
  <div class="col-md-12">
      <div class="card">
          <div class="header">
              <h4 class="title"><b>Inclusão de aluno</b></h4>
          </div>
          <div class="content">
                  <div class="row">
                      ...
                      <div class="col-md-4">
                          <div class="form-group">
                              <p>Nome completo</p>
                              <input type="text" id="nome" class="form-control" required value="">
                          </div>
                      </div>
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                              <p>Naturalidade</p>
                              <input type="text" id="naturalidade" class="form-control" required value="">
                          </div>
                      </div>
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                            <p>Altura (m)</p>
                              <input type="number" id="altura" class="form-control" required value="">
                          </div>
                      </div>
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                              <p>Peso (KG)</p>
                              <input type="number" id="peso" class="form-control" required value="">
                          </div>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <p>Nascimento</p>
                            <input type="date" id="data_nascimento" class="form-control" required value="">
                        </div>
                    </div>
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                              ...
                              <input type="number" id="telefone" class="form-control" required value="">
                          </div>
                      </div>
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                              <p>Fone emergência</p>
                              <input type="number" id="telefone_emergencia" class="form-control" required value="">
                          </div>
                      </div>
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                              <p>Endereço</p>
                              <input type="text" id="endereco" class="form-control" required value="">
                          </div>
                      </div>
                      ...
                      <div class="col-md-1">
                          <div class="form-group">
                              <p>Número</p>
                              <input type="number" id="numero" class="form-control" required value="">
                          </div>
                      </div>
                      ...
                      <div class="col-md-2">
                          <div class="form-group">
                              <p>Complemento</p>
                              <input type="text" id="complemento" class="form-control" required value="">
                          </div>
                      </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <p>Bairro</p>
                            <input type="text" id="bairro" class="form-control" required value="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <p>Cidade</p>
                            <input type="text" id="cidade" class="form-control" required value="">
                        </div>
                    </div>
                  ...
                  <div class="col-md-3">
                      <div class="form-group">
                          ...
                          <input type="number" id="crm" class="form-control" value="">
                      </div>
                  </div>
                ...
                <div id="resp_existente" style="display:none;background-color:#eaeaea;borde-radius:7px;margin-top:40px;" class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group" style="margin-top:22%">
                      <button type="button" id="salvar_responsavel" name="button" class="btn btn-success">Salvar responsavel</button>
                    </div>
                  </div>
                ...
                <div id="resp_novo" style="display:none;background-color:#eaeaea;borde-radius:7px;padding-left:20px;padding-right:20px;margin-top:40px;">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <p>Email</p>
                            <input type="email" id="email_novo" class="form-control" value="">
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <p>CPF</p>
                            <input type="number" placeholder="Somente números"id="cpf_novo" class="form-control" value="">
                        </div>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <select class="selectpicker form-control" data-live-search="true" id="estado_novo">
                              <option value="AC">AC</option>
                              <option value="AL">AL</option>
                              <option value="AP">AP</option>
                              <option value="AM">AM</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <p>Telefone</p>
                            <input type="number" id="telefone_novo" class="form-control" value="">
                        </div>
                    </div>
              ...
              <div class="row">
                ...
                <div class="col-md-2" style="float:right">
                    <div class="form-group">
                        <button type="button" id="conclui_cadastro" class="btn btn-success">Concluir cadastro</button>
                    </div>
                </div>
...
$(function(){
  ...
  $("#conclui_cadastro").click(function(){
    ...
    $.post(
      base_url+'index.php/ajax/cadastro_aluno',{
        aluno: aluno,
