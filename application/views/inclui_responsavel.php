<div class="row">
  <div class="col-md-12">
      <div class="card">
          <div class="header">
              <h4 class="title">Inclusão de Responsável</h4>
          </div>
          <div class="content">
              <?php echo form_open('admin/inclui_responsavel', 'id = inclui_responsavel'); ?>
                  <div class="row">
                      <div class="col-md-5">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <button type="button" class="btn btn-info btn-fill pull-right" onclick="verifica_info()" style="margin-top:10%;margin-right:30%;">Incluir Responsável</button>
                      </div>
                    </div>
                  </div>
